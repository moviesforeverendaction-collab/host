...
# ── Railway persistent storage root (/storage is your mounted 1TB disk) ──────
DATA_DIR = os.environ.get('STORAGE_ROOT', '/storage') + '/data'
os.makedirs(DATA_DIR, exist_ok=True)

# Override tempfile default dir so uploads land on persistent storage
tempfile.tempdir = DATA_DIR

BOT_TOKEN  = os.environ.get('BOT_TOKEN')
MONGODB_URI = os.environ.get("MONGODB_URI")
LOG_CHANNEL_ID = -1003144372708
OWNER_ID   = 1633472140
ADMIN_IDS  = [1633472140]
